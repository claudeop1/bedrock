...
docker run $DOCKER_RUN_FLAGS \
    --name bedrock-wine-builder-cont \
    -v "$PROJECT_ROOT_OR_FRESHCLONE_ROOT":/opt/wine64/drive_c/bedrock \
    --rm \
    --workdir /opt/wine64/drive_c/bedrock/contrib/build-wine \
    bedrock-wine-builder-img \
    ./make_win.sh
