...
KEYRING_PYTHON_DEV="keyring-bedrock-build-python-dev.gpg"
...
cp "$DLL_TARGET_DIR"/*.dll "$WINEPREFIX/drive_c/bedrock/bedrock/" || fail "Could not copy DLLs to destination"
