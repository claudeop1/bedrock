...
see [issue #5159](https://github.com/spesmilo/bedrock/issues/5159).
...
Execute the binary as follows: `./bedrock*.AppImage --appimage-extract`

### How to investigate diff between binaries if reproducibility fails?
```
cd dist/
./bedrock-*-x86_64.AppImage1 --appimage-extract
mv squashfs-root/ squashfs-root1/
./bedrock-*-x86_64.AppImage2 --appimage-extract
