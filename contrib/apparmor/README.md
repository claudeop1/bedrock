...
```
Look for the entry corresponding to `bedrock`

## Usage 
After installing the AppArmor profile, bedrock will be restricted to the permissions specified in the profile.
