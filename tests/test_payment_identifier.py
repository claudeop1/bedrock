...
from bedrock.payment_identifier import (
...
from bedrock.lnurl import LNURL6Data, LNURL3Data, LNURLError
...
class TestPaymentIdentifier(BedrockTestCase):
    def setUp(self):
        super().setUp()
    ...
    @patch('bedrock.payment_identifier.request_lnurl')
