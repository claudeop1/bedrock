...
from bedrock.simple_config import SimpleConfig, read_user_config
...
class Test_SimpleConfig(BedrockTestCase):
    ...
    def tearDown(self):
        ...
        shutil.rmtree(self.bedrock_dir)
    ...
    def test_simple_config_command_line_overrides_everything(self):
        ...
        sources"""
        fake_read_user = lambda _: {"bedrock_path": "b"}
        read_user_dir = lambda : self.user_dir
        config = SimpleConfig(options=self.options,
                              read_user_config_function=fake_read_user,
                              read_user_dir_function=read_user_dir)
        self.assertEqual(self.options.get("bedrock_path"),
                         config.get("bedrock_path"))
    ...
    def test_simple_config_user_config_is_used_if_others_arent_specified(self):
        ...
        fake_read_user = lambda _: {"bedrock_path": self.bedrock_dir}
        read_user_dir = lambda : self.user_dir
    ...
    def test_can_set_options_set_in_user_config(self):
        ...
        config = SimpleConfig(options={},
                              read_user_config_function=fake_read_user,
                              read_user_dir_function=read_user_dir)
        config.set_key("bedrock_path", another_path)
        self.assertEqual(another_path, config.get("bedrock_path"))
    ...
    def test_user_config_is_not_written_with_read_only_config(self):
        ...
        contents = None
        with open(os.path.join(self.bedrock_dir, "config"), "r") as f:
            contents = f.read()
...
class TestUserConfig(BedrockTestCase):
