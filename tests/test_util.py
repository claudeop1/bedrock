...
from bedrock.util import (format_satoshis, format_fee_satoshis, is_hash256_str, chunks, is_ip_address,
                           ...
                           ShortID)
from bedrock.bip21 import parse_bip21_URI, InvalidBitcoinURI
from . import BedrockTestCase, as_testnet


class TestUtil(BedrockTestCase):
    ...
    def test_parse_URI_address_label(self):
        self._do_test_parse_URI('bitcoin:15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma?label=bedrock%20test',
                                {'address': '15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma', 'label': 'bedrock test'})

    def test_parse_URI_address_message(self):
        self._do_test_parse_URI('bitcoin:15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma?message=bedrock%20test',
                                {'address': '15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma', 'message': 'bedrock test', 'memo': 'bedrock test'})
    ...
    def test_parse_URI_multiple_args(self):
        self._do_test_parse_URI('bitcoin:15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma?amount=0.00004&label=bedrock-test&message=bedrock%20test&test=none&r=http://domain.tld/page',
                                {'address': '15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma', 'amount': 4000, 'label': 'bedrock-test', 'message': u'bedrock test', 'memo': u'bedrock test', 'r': 'http://domain.tld/page', 'test': 'none'})
