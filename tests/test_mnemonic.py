...
from bedrock import mnemonic
from bedrock import slip39
from bedrock import old_mnemonic
from bedrock.util import bfh
from bedrock.mnemonic import is_new_seed, is_old_seed, calc_seed_type, is_matching_seed, can_seed_have_passphrase
from bedrock.version import SEED_PREFIX_SW, SEED_PREFIX
...
class Test_NewMnemonic(BedrockTestCase):

    def test_mnemonic_to_seed_basic(self):
        # note: not a valid bedrock seed
...
class Test_OldMnemonic(BedrockTestCase):
...
class Test_BIP39(BedrockTestCase):
...
class Test_seeds(BedrockTestCase):
...
class Test_slip39(BedrockTestCase):
