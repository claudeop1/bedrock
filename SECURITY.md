...
1. (preferred) if you have a GitHub account, use the built-in
  ["Report a vulnerability"](https://github.com/spesmilo/bedrock/security/advisories/new)
  flow, or
...
|-------------|----------------------------------------|---------------------------------------------------|
| ThomasV     | thomasv [AT] bedrock [DOT] org        | 6694 D8DE 7BE8 EE56 31BE D950 2BD5 824B 7F94 70E6 |
| SomberNight | somber.night [AT] protonmail [DOT] com | 4AD6 4339 DFA0 5E20 B3F6 AD51 E7B7 48CD AF5E 5ED9 |

These GPG public keys can be found in the Bedrock git repository,
