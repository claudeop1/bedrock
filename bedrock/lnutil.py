...
from bedrock_ecc import CURVE_ORDER, ecdsa_sig64_from_der_sig
from bedrock_ecc.util import bip340_tagged_hash
import dataclasses
import attr
...
def derive_multisig_funding_key_if_we_opened(
    *,
    ...
    funding_key = ecc.ECPrivkey(bip340_tagged_hash(
        tag=b"bedrock/ln_multisig_funding_key/we_opened",
...
def derive_multisig_funding_key_if_they_opened(
    *,
    ...
    node_id_prefix = remote_node_id_or_prefix[0:NODE_ID_PREFIX_LEN]
    funding_key = ecc.ECPrivkey(bip340_tagged_hash(
        tag=b"bedrock/ln_multisig_funding_key/they_opened",
...
class LnFeatures(IntFlag):
    ...
    OPTION_TRAMPOLINE_ROUTING_REQ_BEDROCK = 1 << 150
    OPTION_TRAMPOLINE_ROUTING_OPT_BEDROCK = 1 << 151
    _ln_feature_contexts[OPTION_TRAMPOLINE_ROUTING_REQ_BEDROCK] = (LNFC.INIT | LNFC.NODE_ANN | LNFC.BOLT11_INVOICE | LNFC.BOLT12_INVOICE)
    _ln_feature_contexts[OPTION_TRAMPOLINE_ROUTING_OPT_BEDROCK] = (LNFC.INIT | LNFC.NODE_ANN | LNFC.BOLT11_INVOICE | LNFC.BOLT12_INVOICE)
...
LN_FEATURES_IMPLEMENTED = (
        ...
        | LnFeatures.OPTION_TRAMPOLINE_ROUTING_OPT_BEDROCK | LnFeatures.OPTION_TRAMPOLINE_ROUTING_REQ_BEDROCK
