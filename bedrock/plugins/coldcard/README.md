...
This code connects the public USB API and Bedrock. Leverages all
the good work that's been done by the Bedrock team to support
hardware wallets.
...
Bedrock wallet and save it to MicroSD card. Transport that file
to Bedrock and it will fetch history, blockchain details and then
...
Transaction > From File in Bedrock or really any tool.
...
- I find this command useful (at top level) ... but I'm a VIM user.
    ...
    ctags -f .tags bedrock `find . -name ENV -prune -o -name \*.py`
