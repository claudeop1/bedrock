...
from bedrock import constants, version
from bedrock.gui.common_qt.util import draw_qr, get_font_id
from bedrock.gui.qt.paytoedit import PayToEdit
from bedrock.payment_identifier import PaymentIdentifierType
from bedrock.plugin import hook
from bedrock.i18n import _
from bedrock.transaction import PartialTxOutput, Transaction
from bedrock.util import NotEnoughFunds, make_dir
from bedrock.gui.qt.util import ColorScheme, WindowModalDialog, Buttons, HelpLabel
from bedrock.gui.qt.util import read_QIcon_from_bytes, read_QPixmap_from_bytes, WaitingDialog
from bedrock.fee_policy import FeePolicy
from bedrock.gui.qt.fee_slider import FeeSlider, FeeComboBox

from .timelock_recovery import TimelockRecoveryPlugin, TimelockRecoveryContext


if TYPE_CHECKING:
    from bedrock.gui.qt import BedrockGui
...
class Plugin(TimelockRecoveryPlugin):
    ...
    def __init__(self, parent, config, name: str):
        ...
        self.base_dir = os.path.join(config.bedrock_path(), 'timelock_recovery')
    ...
    def setup_dialog(self, main_window: 'BedrockWindow') -> bool:
        ...
        try:
            ...
            with open(file_path, "w") as json_file:
                json_data = {
                    ...
                    "wallet_kind": "Bedrock",
                    "wallet_version": version.BEDROCK_VERSION,
    ...
    def _paint_recovery_plan_pdf(self, context: TimelockRecoveryContext, painter: QPainter, printer: QPrinter):
        ...
        painter.drawText(
            ...
            f"Bedrock Version: {version.BEDROCK_VERSION} - Plugin Version: {self.plugin_version}"
        )
