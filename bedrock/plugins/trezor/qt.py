...
from bedrock.keystore import ScriptTypeNotSupported
from bedrock.util import ChoiceItem

from bedrock.hw_wallet.qt import QtHandlerBase, QtPluginBase
from bedrock.hw_wallet.trezor_qt_pinmatrix import PinMatrixWidget
from bedrock.hw_wallet.plugin import only_hook_if_libraries_available, OutdatedHwFirmwareException

from bedrock.gui.qt.util import (WindowModalDialog, WWLabel, Buttons, CancelButton,
                                  OkButton, CloseButton, PasswordLineEdit, getOpenFileName, ChoiceWidget)
from bedrock.gui.qt.wizard.wallet import WCScriptAndDerivation, WCHWUnlock, WCHWXPub, WalletWizardComponent
...
PASSPHRASE_HELP = PASSPHRASE_HELP_SHORT + "  " + _(
    "You need to create a separate Bedrock wallet for each passphrase "
