...
from bedrock.keystore import bip39_normalize_passphrase
from bedrock.bip32 import BIP32Node, convert_bip32_strpath_to_intpath as parse_path
from bedrock.logging import Logger
from bedrock.plugin import runs_in_hwd_thread
from bedrock.hw_wallet.plugin import OutdatedHwFirmwareException, HardwareClientBase
    ...
    def session(self):
        if self._session is None:
            ...
            if not features.passphrase_protection:
                ...
                # the device asks for the passphrase itself, prompting in bedrock as well would make the user enter it twice
