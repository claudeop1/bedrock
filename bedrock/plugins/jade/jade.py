...
from bedrock.transaction import PartialTransaction, Transaction
...
from bedrock.plugin import runs_in_hwd_thread, Device
from bedrock.network import Network

from bedrock.hw_wallet import HW_PluginBase, HardwareClientBase
from bedrock.hw_wallet.plugin import OutdatedHwFirmwareException
...
#if LOGGING:
#    logger = logging.getLogger('bedrock.plugins.jade.jadepy.jade')
#    logger.setLevel(LOGGING)
#    device_logger = logging.getLogger('bedrock.plugins.jade.jadepy.jade-device')
...
def _register_multisig_wallet(wallet, keystore, address):
    ...
    # NOTE: bedrock multisigs appear to always be sorted-multisig
