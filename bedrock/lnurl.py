...
from bedrock import segwit_addr, util
from bedrock.segwit_addr import bech32_decode, Encoding, convertbits, bech32_encode
from bedrock.bolt11 import BOLT11DecodeException, BOLT11EncodeException
...
async def callback_lnurl(url: str, params: dict) -> dict:
    ...
    if 'successAction' in response:
        raise LNURLError("successAction are not yet supported by Bedrock.")
