...
try:
    ...
    from bedrock._vendor import pyperclip

from bedrock.gui import BaseBedrockGui
from bedrock.bip21 import parse_bip21_URI
from bedrock.util import format_time
from bedrock.util import EventListener, event_listener
from bedrock.bitcoin import is_address, address_to_script
...
from bedrock.network import NetworkParameters, TxBroadcastError, BestEffortRequestFailed, ProxySettings
from bedrock.interface import ServerAddr
from bedrock.invoices import Invoice
...
class BedrockGui(BaseBedrockGui, EventListener):
    ...
    def __init__(self, *, config: 'SimpleConfig', daemon: 'Daemon', plugins: 'Plugins'):
        ...
        if not storage.file_exists():
            print("Wallet not found. try 'bedrock create'")
            exit()
