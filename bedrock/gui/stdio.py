...
from bedrock import WalletStorage, Wallet
from bedrock.wallet import Abstract_Wallet
from bedrock.wallet_db import WalletDB
from bedrock.util import format_satoshis, EventListener, event_listener
from bedrock.bitcoin import is_address, COIN
...
class BedrockGui(BaseBedrockGui, EventListener):
    ...
    def network_dialog(self):
        print("use 'bedrock setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'bedrock setconfig' to change your settings")
        return True
