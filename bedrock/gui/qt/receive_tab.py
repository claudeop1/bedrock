...
from bedrock.util import InvoiceError, ChoiceItem
from bedrock.invoices import pr_expiration_values
...
if TYPE_CHECKING:
    ...
    from bedrock.wallet import Request
...
class ReceiveTab(QWidget, MessageBoxMixin, Logger):
    ...
    def expiry_dialog(self):
        msg = ''.join([
            ...
            _('The bitcoin address never expires and will always be part of this bedrock wallet.'), ' ',
