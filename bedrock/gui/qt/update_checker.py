...
from bedrock import version
from bedrock import constants
from bedrock.bitcoin import verify_usermessage_with_address
from bedrock.i18n import _
from bedrock.util import make_aiohttp_session
from bedrock.logging import Logger
from bedrock.network import Network
from bedrock._vendor.distutils.version import StrictVersion


class UpdateCheck(QDialog, Logger):
    url = "https://bedrock.org/version"
    download_url = "https://bedrock.org/#download"
    ...
    def __init__(self, *, latest_version=None):
        ...
        self.setWindowTitle('Bedrock - ' + _('Update Check'))
        ...
        versions.addWidget(QLabel(_("Current version: {}").format(version.BEDROCK_VERSION)))
    ...
    def is_newer(latest_version):
        return latest_version > StrictVersion(version.BEDROCK_VERSION)
    ...
    def update_view(self, latest_version=None):
        if latest_version:
            ...
            if self.is_newer(latest_version):
                ...
                self.detail_label.setText(_("You are already on the latest version of Bedrock."))
        else:
            self.heading_label.setText('<h2>' + _("Checking for updates...") + '</h2>')
            self.detail_label.setText(_("Please wait while Bedrock checks for available updates."))
