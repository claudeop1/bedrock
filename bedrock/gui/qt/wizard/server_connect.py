...
from bedrock.wizard import ServerConnectWizard
from bedrock.gui.qt.network_dialog import ProxyWidget, ServerWidget
from bedrock.gui.qt.util import icon_path
...
class QEServerConnectWizard(ServerConnectWizard, QEAbstractWizard):
    ...
    def __init__(self, config: 'SimpleConfig', app: 'QBedrockApplication', plugins: 'Plugins', daemon: 'Daemon', parent=None):
...
class WCWelcome(WizardComponent):
    def __init__(self, parent, wizard):
        ...
        self.wizard_title = _('Bedrock Bitcoin Wallet')
        ...
        self.config_server_w = QCheckBox(_('Select Bedrock Server'))
