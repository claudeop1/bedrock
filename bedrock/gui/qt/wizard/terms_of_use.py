...
from bedrock.wizard import TermsOfUseWizard
from bedrock.gui.qt.util import icon_path, WWLabel
...
class QETermsOfUseWizard(TermsOfUseWizard, QEAbstractWizard):
    def __init__(self, config: 'SimpleConfig', app: 'QBedrockApplication'):
...
class WCTermsOfUseScreen(WizardComponent):
    def __init__(self, parent, wizard):
        ...
        self.wizard_title = _('Bedrock Terms of Use')
        self.img_label = QLabel()
        pixmap = QPixmap(icon_path('bedrock_darkblue_1.png'))
        self.img_label.setPixmap(pixmap)
        self.img_label2 = QLabel()
        pixmap = QPixmap(icon_path('bedrock_text.png'))
