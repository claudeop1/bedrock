...
from bedrock.util import ShortID
from bedrock.i18n import _
from bedrock.lnutil import LOCAL, REMOTE, UpdateAddHtlc, Direction
from bedrock.lnchannel import Channel, AbstractChannel, HTLCWithStatus
...
class ChannelDetailsDialog(QtWidgets.QDialog, MessageBoxMixin, QtEventListener):
    ...
    def __init__(self, window: 'BedrockWindow', chan: AbstractChannel):
