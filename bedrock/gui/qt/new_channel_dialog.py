...
from bedrock.lnworker import hardcoded_trampoline_nodes
from bedrock.util import NotEnoughFunds, NoDynamicFeeEstimates
...
if TYPE_CHECKING:
    from bedrock.transaction import PartialTxInput
    ...
    def __init__(
        ...
        *,
        ...
        if self.network.channel_db:
            ...
            # index 1 is "Bedrock trampoline" on mainnet, this defaults to -1 if 1 is not available
