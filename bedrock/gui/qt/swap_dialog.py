...
from bedrock_aionostr.util import from_nip19

from bedrock.i18n import _
from bedrock.util import NotEnoughFunds, NoDynamicFeeEstimates, UserCancelled, trigger_callback
from bedrock.bitcoin import DummyAddress
from bedrock.transaction import PartialTxOutput, PartialTransaction, PartialTxInput
from bedrock.fee_policy import FeePolicy
from bedrock.submarine_swaps import NostrTransport

from bedrock.gui.common_qt.util import QtEventListener, qt_event_listener
...
if TYPE_CHECKING:
    ...
    from bedrock.submarine_swaps import SwapServerTransport, SwapOffer
...
class SwapServerDialog(WindowModalDialog, QtEventListener):
    ...
    def __init__(self, window: 'BedrockWindow', servers: Sequence['SwapOffer']):
