...
from bedrock.invoices import InvoiceError, PR_PAID, PR_BROADCASTING, PR_BROADCAST
...
from bedrock.crypto import pw_decode_with_version_and_mac
...
class QEWallet(AuthMixin, QObject, QtEventListener):
    ...
    # so we have only one QEWallet for each bedrock.wallet
    @classmethod
