...
from bedrock.gui.qml.qetypes import QEBytes
from bedrock.util import send_exception_to_crash_reporter
...
class QEQRScanner(QObject):
    ...
    def open(self):
        if 'ANDROID_DATA' not in os.environ:
            ...
            return
        jSimpleScannerActivity = autoclass("org.bedrock.qr.SimpleScannerActivity")
