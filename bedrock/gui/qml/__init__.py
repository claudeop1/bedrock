...
from .qeapp import BedrockQmlApplication, Exception_Hook
...
class BedrockGui(BaseBedrockGui, Logger):
    ...
    def __init__(self, config: 'SimpleConfig', daemon: 'Daemon', plugins: 'Plugins'):
        ...
        self.app = BedrockQmlApplication(sys.argv, config=config, daemon=daemon, plugins=plugins)
        ...
        self.app.engine.load('bedrock/gui/qml/components/main.qml')
