...
from bedrock.wallet import Wallet, create_new_wallet
from bedrock.wallet_db import WalletDB
from bedrock.commands import Commands
from bedrock.util import create_and_start_event_loop, log_exceptions


loop, stopping_fut, loop_thread = create_and_start_event_loop()

config = SimpleConfig({"testnet": True})  # to use ~/.bedrock/testnet as datadir
