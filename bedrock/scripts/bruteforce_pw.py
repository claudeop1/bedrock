...
# Bedrock wallet file password. As it is pure-python and runs in the CPU,
...
# Storage-encryption was introduced in Bedrock 2.8, keystore-encryption predates that.
# Newly created wallets in modern Bedrock have storage-encryption enabled by default.
#
...
from bedrock.util import InvalidPassword
